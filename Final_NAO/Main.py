...
# responsible for facilitating the integration of the FaceIdent3, AIConvoModel and the ClientServer 

def main():
    face_dir = "faces" # name of the folder storing the faces, folder must be within the current working directory
